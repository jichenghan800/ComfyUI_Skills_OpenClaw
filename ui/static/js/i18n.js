...
const messages = {
  ...
  zh: {
    ...
    import_bundle_preview_title: "导入预检",
    export_bundle_confirm: "开始导出",
    import_bundle_confirm: "确认导入",
    export_panel_hint: "选择要导出的服务器和工作流，默认全部选中。",
    export_preview_summary: "本次导出将包含 {servers} 个服务器和 {workflows} 个工作流，警告 {warnings} 条。",
    ...
    export_toggle_server: "展开或收起 {server} 的工作流",
    ...
    transfer_section_empty: "这个区块没有项目。",
    transfer_warning_title: "警告",
    ok_transfer_export_started: "已开始下载导出文件。",
    ok_transfer_import: "导入完成。新增 {servers} 个服务器，导入 {created} 个工作流，覆盖 {overwritten} 个工作流。",
    err_transfer_invalid_bundle: "这个文件不是有效的 bundle JSON。",
    err_transfer_preview: "预检导入包失败。",
    err_transfer_import: "导入 bundle 失败。",
    transfer_apply_environment: "同时应用 bundle 中的默认服务器、URL 和输出目录",
    transfer_preview_summary: "本次导入将新增 {servers} 个服务器，更新 {updated_servers} 个服务器，导入 {created} 个工作流，覆盖 {overwritten} 个工作流，跳过 {skipped} 项，警告 {warnings} 条。是否继续？",
    add_server: "添加服务器",
    server_name: "服务器名称",
