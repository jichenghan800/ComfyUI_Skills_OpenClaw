export function getElements() {
  ...
  return {
    ...
    transferModalOverlay: $("#transfer-modal-overlay"),
    transferModalTitle: $("#transfer-modal-title"),
    transferModalConfirmBtn: $("#btn-confirm-transfer-modal"),
    transferModalCancelBtn: $("#btn-cancel-transfer-modal"),
    transferExportPanel: $("#transfer-export-panel"),
    transferExportSummary: $("#transfer-export-summary"),
    transferExportHint: $("#transfer-export-hint"),
    transferExportTree: $("#transfer-export-tree"),
    transferExportWarnings: $("#transfer-export-warning-list"),
    transferImportPanel: $("#transfer-import-panel"),
    transferImportSummary: $("#transfer-import-summary"),
    transferImportSections: $("#transfer-import-sections"),
    transferImportApplyEnvironment: $("#transfer-import-apply-environment"),
    transferImportApplyEnvironmentLabel: $("#transfer-import-apply-environment-label"),
    // ── Workflow list ──
